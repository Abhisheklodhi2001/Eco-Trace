...
module.exports = {
  ...
  findFlightSpendEmissionFactor: async (CountryId, year) => {
    return await db.query("select * from flight_spend_base_emissionfactor where country_id = ? and Right(Fiscal_Year, 4) = ? ", [CountryId, year])
  }
