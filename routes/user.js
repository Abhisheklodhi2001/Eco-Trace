...
router.get('/download-excel-temlate', auth, userController.downloadExcelTemlate);

// @03-08-2025

router.get('/login_logo', userController.loginLogo);
router.get('/dasboard_logo', auth, userController.dasboardLogo);
router.get('/redirect-url', auth, userController.redirectUrl);
